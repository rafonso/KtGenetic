...
import rafael.ktgenetic.core.events.NoListener
...
class PicturesComparsionView : GeneticView<Rectangle, Screen>("Pictures Comparsion", GeneticCrossingType.SIMPLE) {
